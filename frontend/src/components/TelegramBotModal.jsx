...
export default function TelegramBotModal() {
  ...
  return (
    <div className="bg-sky-50/70 dark:bg-sky-950/30 border border-sky-200 dark:border-sky-800/80 rounded-2xl p-3.5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs transition-colors">
      <div className="flex items-center gap-3">
        ...
        <div>
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <span className="bg-sky-100 dark:bg-sky-900 text-sky-800 dark:text-sky-200 text-[10px] font-mono px-2 py-0.2 rounded-full font-bold">
              @awaaz_ai_civic_bot
            </span>
          </div>
      ...
      <div className="flex items-center gap-2 self-stretch sm:self-auto justify-end shrink-0">
        <a
          ...
          className="bg-sky-600 hover:bg-sky-700 text-white font-bold text-xs px-3.5 py-1.5 rounded-xl transition flex items-center gap-1.5 shadow-xs"
        >
        ...
        <Link
          ...
          className="text-sky-700 dark:text-sky-300 hover:text-sky-900 dark:hover:text-white text-[11px] font-bold px-2 py-1 rounded-lg hover:bg-sky-100/60 dark:hover:bg-sky-900/40 transition"
        >
